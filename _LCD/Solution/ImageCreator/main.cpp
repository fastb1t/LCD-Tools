...
{
    const TCHAR szWindowName[] = _T("ImageCreator");
    const TCHAR szClassName[] = _T("__imagecreator__class__");
    const TCHAR szMutexName[] = _T("__imagecreator__mutex__");
