...
{
    const TCHAR szWindowName[] = _T("FontCreator (5x8 px)");
    const TCHAR szClassName[] = _T("__fontcreator__class__");
    const TCHAR szMutexName[] = _T("__fontcreator__mutex__");
    ...
    else
    {
        ...
        {
            MessageBox(NULL, _T("Another instance is already running."), _T("Error!"), MB_OK | MB_ICONERROR | MB_TOPMOST);
